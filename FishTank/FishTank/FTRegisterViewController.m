...
-(UIButton *)registerBtn{
    if (!_registerBtn) {
        _registerBtn = [[UIButton alloc]initWithFrame:CGRectMake(UIScreenWidth*0.22, _confirmPasswordTF.frame.origin.y+UIScreenHeight*0.142, UIScreenWidth*0.562, UIScreenHeight*0.0433)];
        ...
        _registerBtn.titleLabel.font = FONT_19;
        ...
        [_registerBtn.layer setBorderColor:color];
...
-(void)insertUserTable{
    ...
    //调用Post方法上传数据
    [manager POST:@"http://127.0.0.1/FIshTank/Home/Index/register" parameters:paramDict progress:^(NSProgress * _Nonnull uploadProgress) {
