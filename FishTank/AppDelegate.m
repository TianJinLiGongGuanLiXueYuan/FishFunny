...
#define appKey @"15032ee5492e0"
#define appSecrect @"d18ca5c37fe50f84b2b10088b995b39f"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if (self.isLogin) {
        ...
        FTFirstViewController *firstVC = [[FTFirstViewController alloc]init];
